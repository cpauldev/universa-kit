...
const inputGroupAddonVariants = cva(
  "[&_svg]:-mx-0.5 not-has-[button]:**:[svg]:not([class*='opacity-'])]:opacity-80 flex h-auto cursor-text select-none items-center justify-center gap-2 [&>kbd]:rounded-[calc(var(--radius)-5px)] in-[[data-slot=overlay-input-group]:has([data-slot=overlay-input-control],[data-slot=overlay-textarea-control])]:[&_svg:not([class*='size-'])]:size-4.5 sm:in-[[data-slot=overlay-input-group]:has([data-slot=overlay-input-control],[data-slot=overlay-textarea-control])]:[&_svg:not([class*='size-'])]:size-4",
  {
    defaultVariants: {
      align: "inline-start",
    },
    variants: {
      align: {
        ...
        "inline-end":
          "has-[>:last-child[data-slot=overlay-badge]]:-me-1.5 has-[>button]:-me-2 order-last pe-[calc(--spacing(3)-1px)] has-[>kbd:last-child]:me-[-0.35rem] [[data-size=sm]+&]:pe-[calc(--spacing(2.5)-1px)]",
        "inline-start":
          "has-[>:last-child[data-slot=overlay-badge]]:-ms-1.5 has-[>button]:-ms-2 order-first ps-[calc(--spacing(3)-1px)] has-[>kbd:last-child]:ms-[-0.35rem] [[data-size=sm]+&]:ps-[calc(--spacing(2.5)-1px)]",
      },
    },
  },
);
...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      data-align={align}
      data-slot="overlay-input-group-addon"
      onMouseDown={(e) => {
...
function InputGroupText({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "[&_svg]:-mx-0.5 line-clamp-1 flex items-center gap-2 text-muted-foreground in-[[data-slot=overlay-input-group]:has([data-slot=overlay-input-control],[data-slot=overlay-textarea-control])]:[&_svg:not([class*='size-'])]:size-4.5 sm:in-[[data-slot=overlay-input-group]:has([data-slot=overlay-input-control],[data-slot=overlay-textarea-control])]:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none",
        className,
      )}
      {...props}
    />
